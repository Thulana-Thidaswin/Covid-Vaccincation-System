...
public class Task2{
    ...
    public static Booth arrayBooth[] = {new Booth(),new Booth(),new Booth(),new Booth(),new Booth(),new Booth()};

    public Task2(){

    }
    
    public static void INI(Booth[] arrayBooth) {
        for (int counter = 0; counter < 6; counter++) {
           arrayBooth[counter] = new Booth("Null");
        } 
     }
     /* Same implementation as the task 1 BUT isntead of calling the fucntions , the getter booth and Center is used to 
     call the fucntions into the main program*/
